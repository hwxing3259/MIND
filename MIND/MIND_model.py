...
class MIND(nn.Module):
    ...
    def mc_kl_term(self, emb, post_mean, post_log_std, idx_list):
        ...
        :param emb: N*emb_dim, only emb[idx_list] is in the computation graph
        :param post_mean: len(idx_list)*emb_dim, posterior mean of embeddings of patients in idx_list
        :param post_log_std: len(idx_list)*emb_dim, posterior std of embeddings of patients in idx_list
        :param idx_list: list of patients in the batch
        :return:
        '''
